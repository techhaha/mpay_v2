...
class EpayV1Validator extends Validator
{
    ...
    protected array $scenes = [
        'submit' => ['pid', 'type', 'out_trade_no', 'notify_url', 'return_url', 'name', 'money', 'param', 'device', 'auth_code', 'openid', 'sub_openid', 'wx_openid', 'mini_openid', 'buyer_id', 'buyer_open_id', 'sub_appid', 'op_app_id', 'sign', 'sign_type'],
        'mapi' => ['pid', 'type', 'out_trade_no', 'notify_url', 'return_url', 'name', 'money', 'param', 'clientip', 'device', 'auth_code', 'openid', 'sub_openid', 'wx_openid', 'mini_openid', 'buyer_id', 'buyer_open_id', 'sub_appid', 'op_app_id', 'sign', 'sign_type'],
