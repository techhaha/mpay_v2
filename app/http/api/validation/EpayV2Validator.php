...
class EpayV2Validator extends Validator
{
    ...
    protected array $attributes = [
        ...
        'buyer_id' => '支付宝用户 ID',
        'buyer_open_id' => '支付宝用户 OPENID',
        'sub_appid' => '子应用 APPID',
        'op_app_id' => '支付宝小程序 APPID',
        'clientip' => '用户 IP',
        'device' => '设备类型',
        'channel_id' => '渠道ID',
        'offset' => '偏移量',
    ...
    protected array $scenes = [
        'submit' => ['pid', 'timestamp', 'sign_type', 'sign', 'type', 'out_trade_no', 'notify_url', 'return_url', 'name', 'money', 'param', 'device', 'auth_code', 'openid', 'sub_openid', 'wx_openid', 'mini_openid', 'buyer_id', 'buyer_open_id', 'sub_appid', 'op_app_id', 'channel_id'],
        'create' => ['pid', 'timestamp', 'sign_type', 'sign', 'type', 'method', 'out_trade_no', 'notify_url', 'return_url', 'name', 'money', 'param', 'auth_code', 'openid', 'sub_openid', 'wx_openid', 'mini_openid', 'buyer_id', 'buyer_open_id', 'sub_appid', 'op_app_id', 'clientip', 'device', 'channel_id'],
