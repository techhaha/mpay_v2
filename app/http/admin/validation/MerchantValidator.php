...
class MerchantValidator extends Validator
{
    ...
    protected array $rules = [
        ...
        'merchant_short_name' => 'sometimes|nullable|string|max:60',
        ...
        'settlement_account_name' => 'sometimes|nullable|string|max:100',
        'settlement_account_no' => 'sometimes|nullable|string|max:100',
        'settlement_bank_name' => 'sometimes|nullable|string|max:100',
        'settlement_bank_branch' => 'sometimes|nullable|string|max:100',
