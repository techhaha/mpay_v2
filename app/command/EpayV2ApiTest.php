...
class EpayV2ApiTest extends Command
{
    ...
    {
        $this->resolve(EpayV2ProtocolService::class);
    ...
    private function resolveMerchantPrivateKey(InputInterface $input, int $merchantId = 0): string
    {
        ...
        throw new CommandException('缺少商户 RSA 私钥，请先执行 epay:v2-bootstrap，或通过 --merchant-private-key / --merchant-private-key-file 提供。');
    }
